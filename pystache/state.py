...
class State(object):
    """
    An object to keep track of the parser's state as it works its way through
    a string to be parsed. Uses sane defaults (that comply with the mustache
    spec), but allows for customization.
    """
